...
def lambda_handler(event, context):
    ...
    try:
        ...
        index_total_jobs_chart.write_image(image_path, format='png', engine='kaleido')
        ...
        # Utilisez le répertoire temporaire pour écrire l'image en tant que fichier temporaire
        image_path = os.path.join(tmp_directory, object_name)
        index_providers_donut_chart.write_image(image_path, format='png', engine='kaleido')
        ...
        # Utilisez le répertoire temporaire pour écrire l'image en tant que fichier temporaire
        image_path = os.path.join(tmp_directory, object_name)
        index_cloud_providers_evolution.write_image(image_path, format='png', engine='kaleido')
        ...
        # Utilisez le répertoire temporaire pour écrire l'image en tant que fichier temporaire
        image_path = os.path.join(tmp_directory, object_name)
        index_job_count_barchart.write_image(image_path, format='png', engine='kaleido')
        ...
        # Utilisez le répertoire temporaire pour écrire l'image en tant que fichier temporaire
        image_path = os.path.join(tmp_directory, object_name)
        index_region_job_count_barchart.write_image(image_path, format='png', engine='kaleido')
        ...
        # Utilisez le répertoire temporaire pour écrire l'image en tant que fichier temporaire
        image_path = os.path.join(tmp_directory, object_name)
        index_techno_table.write_image(image_path, format='png', engine='kaleido')
        ...
        # Utilisez le répertoire temporaire pour écrire l'image en tant que fichier temporaire
        image_path = os.path.join(tmp_directory, object_name)
        index_ville_table.write_image(image_path, format='png', engine='kaleido')
        ...
        # Utilisez le répertoire temporaire pour écrire l'image en tant que fichier temporaire
        image_path = os.path.join(tmp_directory, object_name)
        index_entreprise_table.write_image(image_path, format='png', engine='kaleido')
        ...
        # Utilisez le répertoire temporaire pour écrire l'image en tant que fichier temporaire
        image_path = os.path.join(tmp_directory, object_name)
        index_avg_salary_table.write_image(image_path, format='png', engine='kaleido')
        ...
        # Utilisez le répertoire temporaire pour écrire l'image en tant que fichier temporaire
        image_path = os.path.join(tmp_directory, object_name)
        index_med_salary_table.write_image(image_path, format='png', engine='kaleido')
        ...
        # Utilisez le répertoire temporaire pour écrire l'image en tant que fichier temporaire
        image_path = os.path.join(tmp_directory, object_name)
        dashboard_med_salary_table.write_image(image_path, format='png', engine='kaleido')
        ...
        # Utilisez le répertoire temporaire pour écrire l'image en tant que fichier temporaire
        image_path = os.path.join(tmp_directory, object_name)
        dashboard_techno_table_3_m.write_image(image_path, format='png', engine='kaleido')
        ...
        # Utilisez le répertoire temporaire pour écrire l'image en tant que fichier temporaire
        image_path = os.path.join(tmp_directory, object_name)
        dashboard_ville_table_3_m.write_image(image_path, format='png', engine='kaleido')
        ...
        # Utilisez le répertoire temporaire pour écrire l'image en tant que fichier temporaire
        image_path = os.path.join(tmp_directory, object_name)
        dashboard_entreprise_table_3_m.write_image(image_path, format='png', engine='kaleido')
