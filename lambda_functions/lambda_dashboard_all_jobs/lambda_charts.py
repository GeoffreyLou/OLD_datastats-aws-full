    ...
    try:
        ...
        for i in regions:
            ...
            if dashboard_jobs_count_df['control'].sum() != 0:
                ...
                object_name = f'dashboard_linechart_jobs_evolution_all_{region_for_file}.png'
                ...
                print(f'{region_for_file} : Linechart jobs evolution terminé')
            ...
            if dashboard_top20_plus_df['control'].sum() != 0:
                ...
                # Upload du fichier sur le bucket s3
                object_name = f'dashboard_top20_plus_chart_all_{region_for_file}.png'
                ...
                print(f'{region_for_file} : Top 20 positif technos chart')
            ...
            if dashboard_top20_plus_table_df['control'].sum() != 0:
                ...
                # Upload du fichier sur le bucket s3
                object_name = f'dashboard_top20_plus_table_all_{region_for_file}.png'
                ...
                print(f'{region_for_file} : Top 20 positif technos table')
            ...
            if dashboard_top_20_moins_df['control'].sum() != 0:
                ...
                # Upload du fichier sur le bucket s3
                object_name = f'dashboard_top20_moins_chart_all_{region_for_file}.png'
                ...
                print(f'{region_for_file} : Top 20 negatif technos chart')
            ...
            if dashboard_top_20_moins_df['control'].sum() != 0:
                ...
                # Upload du fichier sur le bucket s3
                object_name = f'dashboard_top20_moins_table_all_{region_for_file}.png'
                ...
                print(f'{region_for_file} : Top 20 négatif technos table')
            ...
            # Upload du fichier sur le bucket s3
            object_name = f'dashboard_med_salary_one_region_table_all_{region_for_file}.png'
            ...
            print(f'{region_for_file} : Tableau salaire médian one region')
            ...
            # Upload du fichier sur le bucket s3
            object_name = f'dashboard_avg_salary_one_region_table_all_{region_for_file}.png'
            ...
            print(f'{region_for_file} : Tableau salaire moyen one region')
            ...
            if dashboard_median_salary_evolution_df['tranche_min'].sum() != 0:
                ...
                # Upload du fichier sur le bucket s3
                object_name = f'dashboard_median_salary_global_evolution_all_{region_for_file}.png'
                ...
                print(f'{region_for_file} : Linechart evolution salaire global')
            ...
            if dashboard_df_cloud_providers_line['control'].sum() != 0 and len(dashboard_df_cloud_providers_line['date'].unique()) > 1:
                ...
                # Upload du fichier sur le bucket s3
                object_name = f'dashboard_cloud_providers_evolution_all_{region_for_file}.png'
                ...
                print(f'{region_for_file} : Linechart providers cloud')
            ...
            if dashboard_donut_df['control'].sum() != 0:
                ...
                # Upload du fichier sur le bucket s3
                object_name = f'dashboard_donut_providers_cloud_all_{region_for_file}.png'
                ...
                print(f'{region_for_file} : Donut providers cloud')
            ...
            if dashboard_techno_table_3m_df['control'].sum() != 0:
                ...
                # Upload du fichier sur le bucket s3
                object_name = f'dashboard_techno_3m_table_all_{region_for_file}.png'
                ...
                print(f'{region_for_file} : Table top technos 3 mois')
            ...
            if dashboard_ville_table_3m_df['control'].sum() != 0:
                ...
                # Upload du fichier sur le bucket s3
                object_name = f'dashboard_ville_3m_table_all_{region_for_file}.png'
                ...
                print(f'{region_for_file} : Table top villes 3 mois')
            ...
            if dashboard_entreprise_table_3m_df['control'].sum() != 0:
                ...
                # Upload du fichier sur le bucket s3
                object_name = f'dashboard_entreprise_3m_table_all_{region_for_file}.png'
                ...
                print(f'{region_for_file} : Table top entreprises 3 mois')
            ...
            if dashboard_techno_table_df['control'].sum() != 0:
                ...
                # Upload du fichier sur le bucket s3
                object_name = f'dashboard_techno_table_12m_all_{region_for_file}.png'
                ...
                print(f'{region_for_file} : Table top technologies 12 mois')
            ...
            if dashboard_ville_table_df['control'].sum() != 0:        
                ...
                # Upload du fichier sur le bucket s3
                object_name = f'dashboard_ville_table_12m_all_{region_for_file}.png'
                ...
                print(f'{region_for_file} : Table top villes 12 mois')
            ...
            if dashboard_entreprise_table_df['control'].sum() != 0:
                ...
                # Upload du fichier sur le bucket s3
                object_name = f'dashboard_entreprise_table_12m_all_{region_for_file}.png'
                ...
                print(f'{region_for_file} : Table top entreprises 12 mois')
