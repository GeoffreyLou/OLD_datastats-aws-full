...
try:
    ...
    for i in regions:
        ...
        if i == 'all':
            ...
            # Utilisez le répertoire temporaire pour écrire l'image en tant que fichier temporaire
            dashboard_med_salary_all_regions_table.write_image(object_name, format='png', engine='kaleido')
        ...
        # Une seule région
            ...
            # Utilisez le répertoire temporaire pour écrire l'image en tant que fichier temporaire
            dashboard_med_salary_one_region_table.write_image(object_name, format='png', engine='kaleido')
            ...
            # Utilisez le répertoire temporaire pour écrire l'image en tant que fichier temporaire
            dashboard_avg_salary_one_region_table.write_image(object_name, format='png', engine='kaleido')
        ...
        if dashboard_techno_table_3m_df['control'].sum() != 0:
            ...
            # Utilisez le répertoire temporaire pour écrire l'image en tant que fichier temporaire
            dashboard_techno_3m_table.write_image(object_name, format='png', engine='kaleido')
        ...
        if dashboard_ville_table_3m_df['control'].sum() != 0:
            ...
            # Utilisez le répertoire temporaire pour écrire l'image en tant que fichier temporaire
            dashboard_ville_3m_table.write_image(object_name, format='png', engine='kaleido')
        ...
        if dashboard_entreprise_table_3m_df['control'].sum() != 0:
            ...
            # Utilisez le répertoire temporaire pour écrire l'image en tant que fichier temporaire
            dashboard_entreprise_3m_table.write_image(object_name, format='png', engine='kaleido')
